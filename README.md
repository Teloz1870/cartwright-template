...
```bash
npx create-cartwright                  # light profile (default): lean website scaffold, 8 curated designs
...
- **`light` (the default)** — a website-mode scaffold with 8 curated design packs and the
...
phone-widget, wishlist, blog, reviews, three-scenes.
