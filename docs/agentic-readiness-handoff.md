...
- `pnpm typecheck`: grøn
- `pnpm test`: 239 filer, 2.526 passed, 2 eksisterende skipped
...
- Verificeret deploy-commit: `97f57bf3b64a5a9b239f90eaa6b041d43641d5a6`
- Beskyttet PR-preview: https://demo-cartwright-51l5l3bvk-teloz-s-projects.vercel.app
- Vercel deployment: `dpl_8VTD7r1NBfCvyPDTT2m1wXtVBSFW`
- Vercel-inspektør: https://vercel.com/teloz-s-projects/demo-cartwright/8VTD7r1NBfCvyPDTT2m1wXtVBSFW
...
- Verified code commit: `97f57bf3b64a5a9b239f90eaa6b041d43641d5a6`
- Protected preview: https://demo-cartwright-51l5l3bvk-teloz-s-projects.vercel.app (`dpl_8VTD7r1NBfCvyPDTT2m1wXtVBSFW`)
- Local gates: lint has zero errors, typecheck and build pass, 2,526 unit/contract tests pass (2 pre-existing skips), and Playwright is 3/3.
- Preview gates: all five crawler user agents return 200; all three server-card paths, typed/annotated MCP tools, structured results, readable resources, REST auth, Redocly-valid OpenAPI, canonical/hreflang, `llms.txt` links, markdown negotiation, rate-limit headers and 404 recovery pass; no 500 runtime logs were observed.
