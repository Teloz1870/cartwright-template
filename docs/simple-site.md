...
| `next build` | ~24 s |
| Boot to HTTP 200 with a rendered H1 | ~3 s |

20 runtime dependencies, 17 dev dependencies, 415 files. Measured cold run, 2026-09-22,
GitHub-hosted ubuntu-latest, create-cartwright@2.9.7, engine v0.58.0 (6b35ec8),
`--profile=site --ref=v0.58.0 --yes --pm=pnpm` — release scaffold gate run 35695214215
