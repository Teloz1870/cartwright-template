...
20 runtime dependencies, 16 dev dependencies, 415 files. Measured cold run, 2026-09-14,
GitHub-hosted ubuntu-latest, create-cartwright@2.9.6, engine v0.57.0 (a9b47d4),
`--profile=site --ref=v0.57.0 --yes --pm=pnpm` — release scaffold gate run 34820928302
