...
Copy and paste this instruction set into **v0.dev**, **Bolt.new**, **Lovable**, **Cursor Composer**, **Windsurf**, or **Gemini** as a system prompt or custom instruction. It ensures that any UI generated aligns perfectly with the Cartwright 2.0 Engine architecture. (Agent CLIs that open the project read their own rules files automatically: `.claude/CLAUDE.md`, `.cursor/rules/cartwright.mdc`, `.github/copilot-instructions.md`, `GEMINI.md`, `.windsurfrules`.)
