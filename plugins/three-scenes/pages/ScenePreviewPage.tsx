...
import { isSceneId } from "@/plugins/three-scenes/scenes/registry";
import { ThreeHero } from "@/plugins/three-scenes/components/ThreeHero";
 ...
 *
 * Segment config (`dynamic`) + the noindex `metadata` stay literal in the
 * route mount (app/[locale]/scene-preview/page.tsx) for Next's static analysis.
 */
