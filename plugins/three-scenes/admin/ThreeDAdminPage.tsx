...
/**
 * Live Canvas (3D) admin page — three-scenes plugin (cartwright-plugin-v1).
 * Mounted at /admin/three-d; the segment config (`dynamic`) stays literal in
 * the route mount (app/admin/three-d/page.tsx) for Next's static analysis.
 */
