 ...
 *
 * Body renderes ALTID gennem renderContentBlocks() (React-tekstnoder, ingen
 * dangerouslySetInnerHTML) — også importeret indhold, der gemmes som markdown.
 * Der findes ingen rå-HTML-sti for body (XSS-safe by construction).
 */
