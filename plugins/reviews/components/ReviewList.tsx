...
export default async function ReviewList({
  ...
  const t = {
    ...
    // Rendered when a review has no author name — the API stores "" rather
    // than a hardcoded word, so the fallback follows the shop's locale.
    anonymous: en ? "Anonymous" : "Anonym",
  };
            ...
            {reviews.map((r) => (
              ...
              >
                <div className="flex flex-wrap items-center gap-2 text-xs text-sol-muted">
                  ...
                  <span className="font-black text-sol-ink">
