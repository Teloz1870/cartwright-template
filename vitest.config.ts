...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      // next/font/google shim: a build-time transform unavailable in the Node
      // test runtime. Design packs (e.g. designs/engineered) load fonts via
      // next/font; without this, importing the design registry crashes tests.
      { find: /^next\/font\/google$/, replacement: path.resolve(__dirname, "tests/shims/next-font.ts") },
    ],
  },
});
