...
export default defineConfig({
  ...
  migrations: {
    ...
    // tsx, IKKE ts-node: Prisma 7's Rust-frie client genereres som ESM-TS-source
    // (app/generated/prisma), som ts-node i CommonJS-mode ikke kan require'e
    // ("exports is not defined in ES module scope"). tsx håndterer ESM-TS natively.
