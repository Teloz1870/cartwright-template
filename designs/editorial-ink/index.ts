...
import { EditorialInkHeader, EditorialInkFooter } from "./chrome";
...
export const editorialInkDesign: DesignPack = {
  ...
  // Editorial Ink owns its frame: a masthead-style header (prism mark +
  // storeName) + a quiet print footer — instead of the shared store chrome.
  siteChrome: { Header: EditorialInkHeader, Footer: EditorialInkFooter },
};
