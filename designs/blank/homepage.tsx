 ...
 *   admin and other routes. A scoped starter (display-font hookup, section
 *   rhythm vars, dark-band utility) ships at examples/blank.css.example —
 *   rename to blank.css to use it.
 *
