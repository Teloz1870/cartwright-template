...
export default function StackHomepage({ settings, genome }: DesignHomepageProps) {
  ...
  const headline = settings?.websiteHeadline || genome?.hero.headline || "Build, ship, scale.";
  const tagline =
    settings?.tagline ||
    genome?.hero.tagline ||
