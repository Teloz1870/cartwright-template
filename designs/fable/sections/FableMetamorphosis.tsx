  ...
  return (
    <section className={`fb-meta relative isolate overflow-clip bg-cw-paper text-cw-ink ${display.variable}`}>
      ...
      <div className="mx-auto max-w-3xl px-6 pt-24 pb-10 text-center sm:pt-32">
        <p className="font-mono text-xs uppercase tracking-[0.24em] text-cw-terracotta">{kicker}</p>
        <h2 className="fb-meta__title mt-5 text-4xl font-medium leading-[1.05] tracking-tight sm:text-5xl">
          {title}
        </h2>
      </div>
