...
export default function FableHomepage({ settings, genome }: DesignHomepageProps) {
  ...
  return (
    <div className="fable-locked-light">
      {/* Fable is a locked-LIGHT design, but the reused Studio atoms carry
          dual-mode `dark:` utilities keyed to the OS preference. Re-pin those
          six utilities to their light twins inside this subtree so dark-OS
          visitors get the same ivory page (.class .class beats .class). */}
      <style>{`
