...
export const driveDesign: DesignPack = {
  ...
  // The DriveShell renders its OWN <main className="drv__wrap"> around every
  // page. Tell the engine not to add its shared <main> wrapper, so there's a
  // single <main> landmark (no nesting) and no min-height fighting the panels.
  layout: { ownsMain: true },
