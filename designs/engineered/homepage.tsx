      ...
      <div className="studio__wrap">
        ...
        <nav className="studio__nav" aria-label="Primary">
          <div className="studio__inner studio__navbar">
            <a className="studio__brand" href="#top">
              <span className="studio__brand-mark" aria-hidden="true">C</span>
              Cartwright
            </a>
          ...
          <div className="studio__inner studio__hero-grid">
            <div>
              ...
              <p className="studio__lede studio__reveal" data-d="3">
                Cartwright is the agency that fuses lightning-fast engineering with
        ...
        <section className="studio__section" id="work" aria-label="Testimonial">
          <div className="studio__inner studio__quote studio__inview">
            <blockquote>
              &ldquo;Cartwright took us from idea to an <em>agent-ready</em> store in under a week — and it sells.&rdquo;
            </blockquote>
        ...
        <section className="studio__section" id="contact">
          <div className="studio__inner">
            <div className="studio__cta studio__inview">
              ...
              <a className="studio__btn" href="mailto:hello@cartwright.app">Email us <Arrow /></a>
            </div>
          </div>
        </section>
        ...
        <footer className="studio__footer">
          <div className="studio__inner">
            <div className="studio__footer-grid">
              <div>
                <div className="studio__brand"><span className="studio__brand-mark" aria-hidden="true">C</span>Cartwright</div>
              ...
              <div>
                <h4>Contact</h4>
                <ul>
                  <li><a href="mailto:hello@cartwright.app">hello@cartwright.app</a></li>
                  <li><a href="#top">cartwright.app</a></li>
                </ul>
              </div>
            </div>
            <div className="studio__footer-bottom">
              <span>© 2026 Cartwright</span>
