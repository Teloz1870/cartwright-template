...
import { EngineeredHeader, EngineeredFooter } from "./chrome";
...
export const engineeredDesign: DesignPack = {
  ...
  // Engineered owns its frame: a dark-luxe header (lattice mark + storeName) +
  // a hairline footer — instead of the shared store chrome.
  siteChrome: { Header: EngineeredHeader, Footer: EngineeredFooter },
};
