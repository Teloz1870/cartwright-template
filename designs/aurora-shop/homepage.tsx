...
export default async function AuroraShopHomepage({
  settings,
  locale,
  featured = [],
  categories = [],
  ...
  return (
    <div className="min-h-screen bg-sol-cream">
      ...
      <StudioValuePropsData
        title={tSf("uspTitle")}
        items={[
          { title: tSf("uspShippingTitle"), body: tSf("uspShippingBody"), icon: "truck" },
          { title: tSf("uspPaymentTitle"), body: tSf("uspPaymentBody"), icon: "shield" },
          { title: tSf("uspQualityTitle"), body: tSf("uspQualityBody"), icon: "star" },
        ]}
      />
