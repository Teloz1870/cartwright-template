...
export const splitHeroDefaults: StudioSplitHeroProps = {
  eyebrow: "Nyt studie",
  headline: "Handmade design, built to last",
  body: "We pair Nordic simplicity with solid craft. Every piece is tailored to your room — from first sketch to final fitting.",
  ctaLabel: "Book en samtale",
  ctaHref: "/kontakt",
  imageSrc: "/studio/split-hero.jpg",
  imageAlt: "A bright workshop with wooden details and handmade furniture",
  reverse: false,
};
