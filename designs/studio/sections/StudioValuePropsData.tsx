...
export const valuePropsDefaults: StudioValuePropsDataProps = {
  ...
  items: [
    { title: "Fast delivery", body: "Shipped the same day on weekdays.", icon: "truck" },
    { title: "Secure payment", body: "Encrypted checkout and buyer protection.", icon: "shield" },
    { title: "Topkvalitet", body: "Carefully chosen products we stand behind ourselves.", icon: "star" },
  ],
};
