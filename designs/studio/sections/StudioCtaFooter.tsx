  ...
  return (
    <section className="border-b border-cw-stone-200 dark:border-cw-stone-800">
      <div className="mx-auto max-w-6xl px-6 py-24 text-center">
        <h2
          className="mx-auto max-w-2xl text-3xl sm:text-4xl font-semibold tracking-tight text-cw-stone-900 dark:text-cw-stone-50"
          {...titleAttrs}
        >
          {title}
        </h2>
        {description ? (
          <p
            className="mt-4 max-w-xl mx-auto text-base text-cw-stone-500 dark:text-cw-stone-400"
            {...descriptionAttrs}
          >
            {description}
          </p>
