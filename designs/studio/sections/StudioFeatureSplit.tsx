...
export const featureSplitDefaults: StudioFeatureSplitProps = {
  ...
  title: "Et studie bygget på håndværk og omtanke",
  body: "Vi tager hånd om hele rejsen — fra første skitse til færdig levering. Du får en fast kontakt, en gennemtænkt proces og et resultat, der holder i mange år.",
  bullets: [
    "Personlig rådgivning fra start til slut",
    "Gennemtestede materialer i høj kvalitet",
    "Fast pris uden skjulte gebyrer",
    "Levering til tiden — hver gang",
  ],
  imageSrc: "/studio/feature-split.jpg",
  imageAlt: "Detaljebillede fra studiets værksted",
  reverse: false,
};
