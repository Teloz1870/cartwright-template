...
export const testimonialsDefaults: StudioTestimonialsProps = {
  ...
  items: [
    { quote: "Bedste oplevelse jeg har haft online.", author: "Mette K.", role: "Verified buyer" },
    { quote: "Fast delivery and fantastic quality.", author: "Jonas P.", role: "Verified buyer" },
    { quote: "I recommend them to all my friends.", author: "Sofie L.", role: "Verified buyer" },
  ],
};
