  ...
  items: [
    {
      ...
      alt: "Handmade ceramics drying on a wooden rack in the workshop",
      caption: "Throwing on the wheel",
    },
    {
      src: "/images/studio/gallery-02.jpg",
      alt: "Glazed bowls lined up in rows before firing",
      caption: "Glazing before firing",
    },
    {
      src: "/images/studio/gallery-03.jpg",
      alt: "Close-up of a cup with a matte-glazed surface",
      caption: "Detalje i matglasur",
    },
    {
      src: "/images/studio/gallery-04.jpg",
      alt: "The open kiln with finished pieces in warm light",
    },
  ],
};
