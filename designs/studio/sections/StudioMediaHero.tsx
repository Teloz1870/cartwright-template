...
export const mediaHeroDefaults: StudioMediaHeroProps = {
  ...
  headline: "Handmade ceramics, fired in our own kiln",
  tagline:
    "Every bowl and cup is thrown by hand and glazed with our own mineral blends. No two pieces are alike.",
  imageSrc: "/images/studio/media-hero.jpg",
  imageAlt: "A potter shaping a clay bowl on a wheel in a bright workshop",
