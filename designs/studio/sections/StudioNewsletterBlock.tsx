...
export const newsletterBlockDefaults: StudioNewsletterBlockProps = {
  ...
  description:
    "Få nye kollektioner, gode tilbud og små historier fra værkstedet direkte i indbakken. Ingen spam — kun det, der er værd at vide.",
  ...
  return (
    <StudioSection>
      ...
      <div className="mx-auto mt-10 flex w-full max-w-md flex-col gap-3 sm:flex-row">
        <input
          type="email"
          placeholder={placeholder ?? "din@email.dk"}
