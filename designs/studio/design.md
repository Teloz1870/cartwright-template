...
## Runtime section-layout override (layoutJson)

Section order and visibility are runtime-overridable via
`BrandingSettings.layoutJson` when the `sectionLayout` feature flag is on.
