...
export type WebshopOverrides = {
  productCard?: ComponentType<{ product: any }>;
  pdpLayout?: ComponentType<{ product: any; children: React.ReactNode }>;
  categoryLayout?: ComponentType<{ category: any; children: React.ReactNode }>;
};
