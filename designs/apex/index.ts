...
import { ApexHeader, ApexFooter } from "./chrome";
...
export const apexDesign: DesignPack = {
  ...
  // Apex owns its frame: a palette-adaptive header that keeps the storefront
  // navigable (shop + cart + account + CTA) and a footer link grid — with the
  // orbit-mark signature motif — instead of the shared store chrome.
  siteChrome: { Header: ApexHeader, Footer: ApexFooter },
};
