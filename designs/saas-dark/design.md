...
description: Dark bg with indigo accents, animated grid + glow, terminal code-snippet hero. Built by Antigravity for Teloz' marketing site — pure dark-mode SaaS aesthetic.
mode: website
premium: false
