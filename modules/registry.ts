...
export const PROFILES: readonly ProfileDefinition[] = [
  ...
  },
  {
    ...
    modules: ["db", "auth", "admin", "pages-db", "contact-form", "agent-core", "mcp", "google-fonts"],
    aliases: ["light"],
  },
  {
    schema: "cartwright-profile-v1",
    ...
    modules: ["db", "auth", "admin", "pages-db", "contact-form", "agent-core", "mcp", "webshop", "feeds", "google-fonts"],
    aliases: [],
  },
  {
    schema: "cartwright-profile-v1",
