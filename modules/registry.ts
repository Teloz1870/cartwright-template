 ...
 * definitions (`internal-docs/site-profile-ultraplan.md`, owner-approved
 * 2026-07-15: site ⊂ managed-site ⊂ commerce ⊂ agentic, additive always).
 *
...
const PLUGIN_MODULE_EXTRAS: Record<
  string,
  { files?: string[]; replaces?: { target: string; with: string }[] }
> = {
  "three-scenes": {
    files: [
