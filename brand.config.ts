...
export const brand = {
   ...
   * identitet). `scene` vælger blandt de fire indbyggede scener; `intensity`
   * (0..1) styrer tæthed/hastighed; `paletteSource` "theme" læser brand-farver
   * fra de injicerede --color-sol-* CSS-vars. DB-override merges i
   * lib/three/resolve.ts.
   */
  threeD: {
    scene: "floating-geometry" as
      | "floating-geometry"
      | "particles"
      | "blob"
      | "wireframe",
  ...
  footer: {
     ...
     */
    ownerUrl: "https://teloz.net" as string,
