...
export default async function ProductPage({ params }: Props) {
  ...
  const pdpTree = (
    <div className="pb-24 md:pb-0">
      ...
      <PdpWebMcpMount locale={locale} product={{ id: product.id, name: productName, slug: product.slug, priceDkk: product.priceDkk, stock: product.stock, variants: variantOptions }} />
    </div>
  );
