...
export default function ChangelogPage() {
  // Engine-transparency gate (brand.website.showAuditFeed): a shop that
  // doesn't surface the engine changelog answers 404 — same page-level gate
  // convention as the flag-gated routes. Default true ⇒ unchanged.
