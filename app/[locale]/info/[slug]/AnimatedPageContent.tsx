...
type AnimatedPageContentProps = {
  ...
  blocks: ContentBlock[];
  /** In-place editing (admin + flag). Gater data-cw-edit på titel + brødtekst. */
  editEnabled?: boolean;
  /** Page-slug — påkrævet for at bygge edit-target'et. */
  slug?: string;
};
...
export default function AnimatedPageContent({
  ...
  const canEdit = editEnabled && !!slug;
    ...
    <div ref={containerRef} className="bg-sol-cream min-h-screen text-sol-ink">
        ...
        <div className="relative h-[50vh] sm:h-[70vh] w-full flex items-end pb-16 sm:pb-24 bg-sol-ink overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
            <motion.h1
              ...
              {...editAttr({ kind: "page", slug, field: "title" }, canEdit)}
            >
              {page.title}
            </motion.h1>
            <motion.div
      ...
      >
        {!page.heroImage && (
          ...
          >
            <h1
              className="text-6xl sm:text-8xl font-black text-sol-ink tracking-tighter mb-6 leading-[1.1]"
              {...editAttr({ kind: "page", slug, field: "title" }, canEdit)}
            >
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 relative">
          ...
          <div
            ...
            {...editAttr({ kind: "page", slug, field: "body" }, canEdit)}
          >
