        ...
        <div className="border-t border-white/10 pt-20 flex flex-col items-center text-center">
          ...
          <div className="flex flex-wrap justify-center gap-12 md:gap-16 opacity-50 grayscale hover:grayscale-0 transition-all duration-500 items-center">
            <div className="flex items-center gap-3 font-bold text-lg">
              ...
              <img src="https://cdn.simpleicons.org/nextdotjs/white" alt="Next.js Logo" loading="lazy" decoding="async" className="h-6 w-6" /> 
              Next.js
            </div>
            <div className="flex items-center gap-3 font-bold text-lg">
            ...
            <div className="flex items-center gap-3 font-bold text-lg">
              {/* eslint-disable-next-line @next/next/no-img-element -- decorative external CDN icon */}
              <img src="https://cdn.simpleicons.org/vercel/white" alt="Vercel Logo" loading="lazy" decoding="async" className="h-6 w-6" /> 
              Vercel
            </div>
          </div>
        </div>
