...
import { ArrowRight, Server, Zap, Shield, Code2 } from "lucide-react";
import { useTranslations } from "next-intl";

export const metadata = {
  title: "Cartwright 2.0 Engine | Teloz",
  description: "Byg lynhurtige, AI-drevne platforme med Cartwright.",
};
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-white/30 selection:text-white pt-32 pb-24">
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col items-center text-center mb-24">
        <div className="mb-6 rounded-full border border-indigo-500/30 bg-indigo-500/10 px-4 py-1.5 text-xs font-semibold tracking-wide uppercase text-indigo-300">
          {t("badge")}
        </div>
        
        <h1 className="text-5xl sm:text-7xl lg:text-8xl font-black text-white tracking-tighter mb-8 leading-[1.1]">
          {t("title1")} <span className="text-indigo-400">{t("title2")}</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
          ...
          <a 
            href="https://github.com/Teloz1870" 
            target="_blank"
            rel="noopener noreferrer"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-32">
        <div className="max-w-4xl mx-auto relative w-full rounded-2xl border border-white/10 bg-[#0A0A0A] overflow-hidden shadow-2xl shadow-indigo-500/10 group">
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="p-10 rounded-2xl border border-white/10 bg-[#0A0A0A] hover:border-white/20 transition-all">
          <svg className="w-8 h-8 text-purple-400 mb-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="p-10 rounded-2xl border border-white/10 bg-[#0A0A0A] hover:border-white/20 transition-all">
          <svg className="w-8 h-8 text-indigo-400 mb-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
