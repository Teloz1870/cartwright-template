...
export default function DomainMigrationPage() {
  return (
    <div className="min-h-screen bg-sol-cream text-sol-ink relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-[var(--cw-brand-on-dark)]/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-[400px] h-[400px] bg-[var(--cw-brand-on-dark)]/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <section className="relative overflow-hidden pt-32 pb-20 sm:pt-40 sm:pb-28 border-b border-sol-ink/5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-7xl font-black tracking-tight mb-6 leading-tight">
            ...
            <span className="bg-gradient-to-r from-[var(--cw-brand-on-dark)] via-[var(--cw-brand-on-dark-hi)] to-[#ffbfa3] bg-clip-text text-transparent">
              Domæneflytning
            </span>
          </h1>
          ...
          <div className="lg:col-span-7">
            ...
            <div className="space-y-8">
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-[var(--cw-brand-on-dark)]/10 border border-[var(--cw-brand-on-dark)]/20 flex items-center justify-center text-[var(--cw-brand-on-dark)] font-bold">
                  ✓
                </div>
                <div>
            ...
            <div className="mt-12 p-8 bg-sol-sand border border-sol-ink/10 rounded-2xl relative overflow-hidden group shadow-2xl">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[var(--cw-brand-on-dark)]/5 rounded-full blur-2xl pointer-events-none group-hover:bg-[var(--cw-brand-on-dark)]/10 transition-colors" />
              <p className="text-xs font-black text-[var(--cw-brand-on-dark)] uppercase tracking-widest">Gennemskuelig Fast Pris</p>
