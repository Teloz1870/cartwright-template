...
export async function GET(request: Request): Promise<Response> {
  ...
  const body = `---
title: "API authentication — ${brand.storeName}"
description: "How agents authenticate against the ${brand.storeName} tool API: Bearer API keys, named scopes, anonymous read surface, rate limits and error model."
canonical: "${base}/auth.md"
last-updated: "${today}"
---
