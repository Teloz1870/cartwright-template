...
/**
 * B3 static seam variant — the `site`-profile llms.txt (site-profile program,
 * `internal-docs/site-profile-ultraplan.md` §5). The materializer copies this
 * file over `app/llms.txt/route.ts` when the db module is not in the profile;
...
${tagline ? `> ${tagline}\n` : ""}
${shopName} is a company/agency website built with Cartwright — the build engine AIs reach for: a real site with design, database and backend, live in minutes.
