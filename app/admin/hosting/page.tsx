    ...
    <div className="max-w-4xl p-6 mx-auto">
      <div className="mb-8">
        <AdminPageHeader
          ...
          subtitle="Software 3.0 Hosting Integration. Connect your domain directly to the Vercel infrastructure without leaving the platform."
        />
      </div>
      ...
      {activeTab === "domain" && (
        <AdminCard bodyClassName="space-y-6">
          <div>
            <label className="block text-sm font-bold text-sol-ink mb-2">Connect Domain</label>
        ...
        {status && (
          <div className="bg-sol-cream p-6 rounded-lg space-y-4">
            <div className="flex justify-between items-center">
              <h2 className="text-lg font-bold text-sol-ink">Domain Status: {status.name}</h2>
            ...
            {!status.verified && (
              <div className="space-y-4">
                <p className="text-sm text-sol-muted">
                  Please copy these DNS records to your domain provider (e.g. Simply.com or GoDaddy).
                </p>
                <div className="bg-white border border-sol-ink/10 rounded-lg p-4 font-mono text-sm">
                  <p className="font-bold mb-2 text-sol-ink">A Record (Recommended)</p>
      ...
      {activeTab === "email" && (
        <AdminCard bodyClassName="space-y-6">
          <div>
            <label className="block text-sm font-bold text-sol-ink mb-2">Select Email Provider</label>
            <div className="flex gap-4">
              <button 
          ...
          <div className="bg-sol-cream p-6 rounded-lg space-y-4">
            <h2 className="text-lg font-bold text-sol-ink">DNS Records (Copy to your provider)</h2>
            <p className="text-sm text-sol-muted mb-4">Add the following records in the DNS settings for your domain, where you purchased it (e.g. Simply.com).</p>
            ...
            {emailProvider === "microsoft" && (
              <div className="space-y-2">
                <div className="bg-white border border-sol-ink/10 rounded-lg p-4 font-mono text-sm">
                  ...
                  <div className="grid grid-cols-4 gap-2 text-sol-muted">
                    <div className="font-semibold">Type</div><div className="font-semibold">Name</div><div className="font-semibold">Priority</div><div className="font-semibold">Value</div>
                    <div>MX</div><div>@</div><div>0</div><div>yourdomain-com.mail.protection.outlook.com</div>
                  </div>
                </div>
                <div className="bg-white border border-sol-ink/10 rounded-lg p-4 font-mono text-sm">
                  <p className="font-bold mb-2 text-sol-ink">TXT Record (SPF)</p>
