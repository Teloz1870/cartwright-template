  ...
  return (
    <div className="max-w-4xl p-6 mx-auto">
      <header className="mb-8">
        <h1 className="text-3xl font-black text-sol-ink">Go-Live Dashboard</h1>
        <p className="mt-2 text-sol-muted">
          Software 3.0 Hosting Integration. Tilknyt dit domæne direkte til Vercel infrastrukturen uden at forlade platformen.
        </p>
      </header>
      ...
      {activeTab === "domain" && (
        <div className="bg-white rounded-xl shadow-sm border border-sol-ink/10 p-6 space-y-6">
          <div>
          ...
          <div className="flex gap-4">
            ...
            <button 
              ...
              className="bg-sol-accent text-white px-6 py-2 rounded-lg font-bold disabled:opacity-50"
            >
              Tilføj Domæne
            </button>
          </div>
        ...
        {status && (
          <div className="bg-sol-cream p-6 rounded-lg space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className={`px-3 py-1 rounded-full text-sm font-bold ${status.verified ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'}`}>
            ...
            {!status.verified && (
              <div className="space-y-4">
                ...
                {status.verification && status.verification.map((v: any, i: number) => (
            ...
            <button 
              ...
              disabled={loading}
              className="w-full bg-white border border-sol-ink/20 text-sol-ink px-4 py-2 rounded-lg font-bold hover:bg-sol-ink/5 disabled:opacity-50"
            >
              Opdater Status
            </button>
          </div>
