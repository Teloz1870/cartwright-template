...
export default async function AdminPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* AI activity today — section highlighted with a navy panel to make the
          AI-first story visible directly in admin. */}
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-white/85">
              Operations are driven by AI clients and customer chat — here is today&apos;s activity
            </p>
          </div>
          <Link
            href="/admin/audit"
