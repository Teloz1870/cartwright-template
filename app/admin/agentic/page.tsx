...
export default async function AgenticDashboardPage() {
  ...
  // eslint-disable-next-line react-hooks/purity -- Server Component render; request-time 24h window for the Prisma queries below.
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <AdminPageHeader
          ...
          subtitle="Live view of A2A (Agent-to-Agent) activity over the past 24 hours. Disputed escrows surface regardless of age."
        />
      </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="text-xs text-sol-muted">
                    {formatAmount(total, brand.policies.currency)}
                  </div>
                </div>
              );
            },
