...
<div className="py-20 text-center">
  <div className="max-w-4xl mx-auto px-4">
    <span className="text-xs font-black uppercase tracking-[0.2em] text-indigo-400">Cartwright Engine</span>
    ...
    try {
      ...
      if (data.html) {
        ...
        setMessage({
          ...
          text:
            activeEngine === "v0"
              ? "Genereret med v0 — renset + saniteret til HTML 🎉"
              ...
              <p className="text-xs text-sol-muted mt-2">
                ...
                {v0Enabled && engine === "v0" && (
                  <span className="text-sol-ink/70">
                    {" "}
                    v0 genererer kode → normaliseres + saniteres til HTML.
                  </span>
                )}
              </p>
              {v0WebUrl && (
