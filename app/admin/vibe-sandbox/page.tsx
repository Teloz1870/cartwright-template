...
export default async function VibeSandboxPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <AdminPageHeader
        title="AI Vibe Sandbox"
        subtitle="Experimental sandbox to preview, test and publish raw HTML/Tailwind code generated by external AI design tools."
      />
      <Suspense fallback={<div className="text-sm font-semibold text-sol-muted">Loading sandbox...</div>}>
