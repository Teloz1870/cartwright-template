...
export default async function LeadsPage() {
  ...
  return (
    <div className="flex flex-col gap-6 p-8">
      <AdminPageHeader
        title="Leads & Projektforespørgsler"
        subtitle="Overblik over indkomne projekter og henvendelser fra Projektberegneren."
      />
        ...
        <AdminTable>
          <AdminThead>
            <tr>
              ...
              <AdminTh>Klient</AdminTh>
              <AdminTh>Projekt</AdminTh>
              <AdminTh>Budget</AdminTh>
              <AdminTh>Status / Prioritet</AdminTh>
              <AdminTh>Besked & AI Triage</AdminTh>
            </tr>
          </AdminThead>
          <AdminTbody>
            {leads.length === 0 ? (
