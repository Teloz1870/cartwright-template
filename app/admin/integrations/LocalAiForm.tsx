 ...
 *
 * Commit 8 udvidede formen med polished empty-states: install-card hvis
 * Ollama er nede, recommendation-cards (Tiny/Anbefalet/Power) hvis tom,
 * og installed-list med delete + total-disk-usage hvis ≥1 model.
 */
