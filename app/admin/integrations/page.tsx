        ...
        tabs={[
          ...
          <div className="flex flex-col gap-8">
            <section className="rounded-2xl border border-sol-ink/10 bg-sol-sand p-6 shadow-sm">
              <div className="mb-5">
                <h2 className="text-lg font-black text-sol-ink">AI provider</h2>
                <p className="mt-1 text-sm text-sol-muted">
                  Vælg mellem cloud (Anthropic) eller lokal AI (Ollama på din
                  egen Mac). Auto-mode prøver lokal først og falder tilbage til
                  cloud hvis Ollama er nede.
                </p>
              </div>
            ...
            {showVoiceShop && voiceShopUi && (
              <section className="rounded-2xl border border-sol-ink/10 bg-sol-sand p-6 shadow-sm">
                <div className="mb-5">
                  <h2 className="text-lg font-black text-sol-ink">Voice Shop (Gemini Live)</h2>
                  <p className="mt-1 text-sm text-sol-muted">
                    Lad kunder snakke direkte med shoppen via stemmen. Kræver
                    Google Gemini API-key (ovenfor) og brand.features.voiceShop=true.
                    Tools eksekveres server-side med samme audit-log som text-chat.
                  </p>
                </div>
            ...
            <section className="rounded-2xl border border-sol-ink/10 bg-sol-sand p-6 shadow-sm">
              <div className="mb-5">
                ...
                <p className="mt-1 text-sm text-sol-muted">
                  Shared server-side connector for Google Sheets, Drive og Docs.
                  Dette er ikke kundernes “Sign in with Google”.
                </p>
              </div>
            ...
            <section className="rounded-2xl border border-sol-ink/10 bg-sol-sand p-6 shadow-sm">
              <div className="mb-5">
                <h2 className="text-lg font-black text-sol-ink">Vercel v0 (UI-generering)</h2>
                <p className="mt-1 text-sm text-sol-muted">
