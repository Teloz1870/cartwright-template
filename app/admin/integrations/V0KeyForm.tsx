      ...
      <form action={handleSubmit} className="space-y-3">
        <label className="block">
          ...
          <span className="mt-1 block text-xs text-sol-muted">
            Bruges til at generere storefront-sektioner via v0 (text→UI) i Vibe Sandbox. Hent en
            key på{" "}
            <a
            ...
            . Keyen sendes kun til serveren og kommer aldrig tilbage i klartekst.
            <br />
            <span className="text-sol-ink/60">
              Privatliv: v0 er opt-out by default. Til GDPR-produktion bør du vælge en
              zero-retention-tier og køre en DPA med Vercel før du sender brand-data.
            </span>
          </span>
        </label>
