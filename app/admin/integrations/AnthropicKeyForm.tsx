...
export default function AnthropicKeyForm({ isSet, preview, envFallback }: Props) {
  ...
  function handleClear() {
    if (!confirm("Remove the Anthropic API key? The AI stylist stops working until a new key is set.")) {
      return;
    }
    startTransition(async () => {
