...
/**
 * The "Import & sync" tab in the Integrations hub (the Shopify "Apps" pattern).
 *
 * v0.25.x: Google Sheets / Drive / Docs import are no longer standalone
 * top-level nav rows — they are collected here as connector cards. The pages
 * themselves (/admin/sheets, /admin/drive, /admin/docs-import) are unchanged and
 * open from here. Each card is gated by its own runtime flag; when the flag is off,
