...
const FIELDS: Array<{
...
}> = [
  {
    ...
    description: "Exposed to the frontend (Stripe Element). Safe to show in a browser.",
  },
  {
    kind: "secret",
    label: "Secret Key",
    placeholder: "sk_test_...",
    description: "Server-side only. Used to create PaymentIntents.",
  },
  {
    kind: "webhook",
    label: "Webhook Secret",
    placeholder: "whsec_...",
    description: "Verifies that webhook events really come from Stripe.",
  },
];
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-sol-muted">
        ...
        . The webhook secret comes from a webhook endpoint setup (see the Phase 3 doc).
      </p>
    </div>
  );
}
