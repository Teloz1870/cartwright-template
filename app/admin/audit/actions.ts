...
/**
 * Roll back an earlier destructive operation. We use the audit.revert tool
 * via the internal registry (the same path as MCP/REST) so auditing of the
 * revert action itself happens automatically.
 */
