...
function ChromeSelect({
  ...
  return (
    <label htmlFor={id} className="flex flex-col gap-1.5">
      <span className="text-xs font-bold uppercase tracking-wider text-sol-muted dark:text-white/50">
        {label}
      </span>
      <select
        id={id}
        ...
        className="h-10 rounded-lg border-2 border-sol-ink/10 bg-white px-3 text-sm font-medium text-sol-ink transition-colors hover:border-sol-ink/30 focus:border-sol-accent focus:outline-none disabled:opacity-60 dark:border-white/10 dark:bg-sol-sand dark:text-white dark:hover:border-white/30"
      >
