...
export default function DesignPromptForm() {
  ...
  return (
    <div className="flex flex-col gap-3 rounded-2xl border border-sol-ink/10 bg-white p-5">
      <div>
        ...
        <p className="mt-1 text-sm font-medium text-sol-muted">
          ...
          <code className="rounded bg-sol-ink/5 px-1 py-0.5 text-xs">/admin/integrations</code>).
        </p>
      </div>
      <textarea
        value={prompt}
        ...
        className="w-full rounded-xl border border-sol-ink/15 bg-sol-sand/40 px-3 py-2 text-sm text-sol-ink outline-none focus-visible:border-sol-accent"
      />
      {msg ? (
        <div
