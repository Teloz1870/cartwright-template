...
type Props = {
  ...
  activeSlug: string;
  /** True if activeSlug came from inferDesignFromIndustry (BrandingSettings.designSlug=null). */
  isInferred: boolean;
...
/**
 * Radio grid of installed designs. The "Auto" option (=null in the DB) is listed
 * first so a fresh install can pick it explicitly. Click → setActiveDesignAction
