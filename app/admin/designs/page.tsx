...
/**
 * v0.7.0 /admin/designs — hub for design-management.
 *
 * Funktioner:
 *   1. Vis alle installed designs (fra DESIGN_OPTIONS — Cartwright-shipped +
 *      imported via CLI / drag-drop)
 *   2. Highlight nuværende active design (BrandingSettings.designSlug, eller
 *      inferredFrom hvis null)
 *   3. "Set active" per-design med server-action → BrandingSettings update
 *   4. Drag-drop upload af design.md (optional --from stitch | claude-design
 *      adapter) → POST /api/admin/designs/import → scaffolder filer
 *
 * Komponenten er Server Component for SSR-fetch af current settings.
 * Selve interaktion (radio-knap + upload) lives i Client Components
 * (DesignSelector, DesignUploader).
 */
export default async function AdminDesignsPage() {
  ...
  return (
    <div className="flex flex-col gap-10">
      <header>
        <h1 className="text-3xl font-black text-sol-ink dark:text-white">
          Designs
        </h1>
      ...
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-black text-sol-ink dark:text-white">
