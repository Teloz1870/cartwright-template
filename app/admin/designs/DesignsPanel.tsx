...
export default async function DesignsPanel() {
  ...
  // Resolved for the same reason: /admin/seo-performance unlocks on the merged
  // value, so reading the compile-time one here left half the admin insisting
  // the shop was not on Plus after the owner had turned it on.
  const cartwrightPlus = features.cartwrightPlus;
