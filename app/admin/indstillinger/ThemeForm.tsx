    ...
    <div className="bg-white rounded-xl shadow-sm border border-sol-ink/10 p-6 space-y-6">
      ...
      <div className="mt-8 pt-6 border-t border-sol-ink/10">
        ...
        <p className="text-sm text-sol-muted mb-4">
          For at lade Vercel v0 eller Cursor injecte kode direkte, send et POST request til <code className="bg-gray-100 px-1 py-0.5 rounded text-xs">/api/admin/vibe/push</code> med din Vibe API Key.
        </p>
        <div className="bg-gray-50 rounded-lg p-4 font-mono text-xs text-sol-muted overflow-x-auto">
