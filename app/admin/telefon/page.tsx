    ...
    <div className="max-w-5xl p-6 mx-auto">
      <div className="mb-8">
        <AdminPageHeader
          ...
          subtitle="Administrer dit virtuelle telefonnummer, opkaldshistorik og AI-svarer direkte fra Cartwright."
          primaryAction={
      ...
      {activeTab === "logs" && (
        <AdminCard title="Seneste Opkald" padding="none">
          {loading ? (
            ...
            <AdminTable>
              <AdminThead>
                <AdminTr>
                  ...
                  <AdminTh>Varighed</AdminTh>
                  <AdminTh>Tidspunkt</AdminTh>
                </AdminTr>
              </AdminThead>
              <AdminTbody>
                {calls.map((call) => (
      ...
      {activeTab === "ivr" && (
        <AdminCard
          title="Text-to-Speech Velkomsthilsen"
          description="Skriv den tekst som Phone.inc's AI stemme automatisk skal læse op, når kunderne ringer uden for åbningstiden."
        >
