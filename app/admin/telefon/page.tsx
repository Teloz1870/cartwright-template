    ...
    <div className="max-w-5xl p-6 mx-auto">
      ...
      <div className="flex gap-4 mb-6">
        <button 
          ...
          className={`flex items-center gap-2 px-6 py-3 font-bold rounded-lg transition-all ${activeTab === "logs" ? "bg-sol-accent text-white" : "bg-white text-sol-ink border border-sol-ink/10"}`}
        >
          <History size={18} /> Opkaldshistorik
        </button>
        <button 
          onClick={() => setActiveTab("ivr")}
          className={`flex items-center gap-2 px-6 py-3 font-bold rounded-lg transition-all ${activeTab === "ivr" ? "bg-sol-accent text-white" : "bg-white text-sol-ink border border-sol-ink/10"}`}
        >
      ...
      {activeTab === "logs" && (
        <div className="bg-white rounded-xl shadow-sm border border-sol-ink/10 overflow-hidden">
      ...
      {activeTab === "ivr" && (
        <div className="bg-white rounded-xl shadow-sm border border-sol-ink/10 p-6">
