...
// component-render, men en almindelig (camelCase) funktion er fri af reglen.
...
export default async function AdminOrderPage({ params }: Props) {
  ...
  const customerAndItems = (
    <>
      ...
      <section id="varer" className="sol-card-elevated">
  ...
  // Flag off → den gamle minimale detalje-visning (reversibelt).
  if (!f.orderWorkspace) {
    return (
  ...
  return (
    <div className="flex max-w-5xl flex-col gap-6">
      ...
      {f.fulfillmentPdf && (
        ...
        >
          <h2 className="mb-4 text-xl font-black text-sol-ink">Fulfillment</h2>
          <div className="flex flex-wrap gap-3">
            ...
            <a
              ...
              className="rounded-lg border border-sol-ink/15 px-4 py-2 text-sm font-black text-sol-ink transition hover:bg-sol-cream/60"
            >
