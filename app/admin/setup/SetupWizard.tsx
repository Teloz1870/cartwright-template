    ...
    <div className="mx-auto max-w-3xl">
      ...
      <div className="rounded-2xl border border-sol-ink/10 bg-sol-sand p-6 shadow-sm">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-sol-muted">
                  ...
                  existing data. Pick the closest match — visual design er separat.
                </p>
              </div>
        ...
        {step === "domain" && (
          <div className="space-y-4">
            <div>
              <h2 className="text-xl font-black text-sol-ink">Domæne, Email & Telefoni</h2>
              <p className="mt-1 text-sm text-sol-muted">
                Vælg dit domæne og hoved-email, tænd rigtig email-udsendelse med Resend, og opsæt Phone.inc for Cloud Telefoni. Alt kan ændres senere. Du behøver ikke email for at logge ind — login er password-baseret.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-sol-ink/10 bg-white p-4 mb-4">
              <h3 className="font-bold text-sol-ink mb-2">2. Email-udsendelse (Resend)</h3>
              <div
              ...
              >
                {initialResendConfigured
                  ? "✅ Rigtige mails sendes (Resend konfigureret)"
                  : "⚠️ Preview-mode — mails skrives til .mail-previews/ indtil en key sættes"}
              </div>
              <p className="text-xs text-sol-muted mb-4">
                Indtast en{" "}
                <a
                ...
                API-key for at sende rigtige emails (ordrebekræftelser, magic-link,
                glemt-adgangskode). Afsender-domænet skal være verificeret i Resend.
              </p>
              <div className="space-y-3">
                <div>
                  <label htmlFor="fromName" className={labelClass}>
                    Afsender-navn (vises i indbakken)
                  </label>
                  <input
                    id="fromName"
                    type="text"
            ...
            <div className="rounded-lg border border-sol-accent/20 bg-sol-accent/5 p-4 mb-4 text-xs leading-5 text-sol-muted">
              <p className="font-bold text-sol-ink mb-1">Din admin-login</p>
              <p>
                Admin-adgangskoden blev sat da databasen blev seedet — vist én gang
                i terminalen og gemt i <code>.admin-credentials</code> (slet filen
                når du har gemt den). Skift den under{" "}
                <Link href="/admin/konto" className="font-bold text-sol-accent underline">
                  Min konto
                </Link>
                . Login er password-baseret, så du behøver ikke email for at komme ind.
              </p>
            </div>
