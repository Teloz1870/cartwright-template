...
export default function SetupWizard({
  ...
  const [aiProvider, setAiProvider] = useState<"anthropic" | "local">("anthropic");
  const [localAiEndpoint, setLocalAiEndpoint] = useState("http://localhost:11434/v1");
  const [localAiModel, setLocalAiModel] = useState("gemma:7b");
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={inputClass}
                placeholder="For example Free shipping over 1000 kr"
                maxLength={160}
              />
            </div>
        ...
        {step === "ai" && (
          <div className="space-y-4">
            <div>
              ...
              <p className="mt-1 text-sm text-sol-muted">
                Vælg hvordan AI-konsulenten (Storefront Chat) skal drives. Du kan bruge Cloud AI (Anthropic Haiku) for nem og hurtig opsætning, eller Lokal AI (Ollama) hvis du ønsker fuld kontrol og færre omkostninger.
              </p>
            </div>
            ...
            <div className="flex gap-4 mb-4">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 text-sol-accent focus:ring-sol-accent/25"
                />
                <span className="text-sm font-bold text-sol-ink">☁️ Cloud AI (Anthropic)</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="radio"
                  ...
                  className="w-4 h-4 text-sol-accent focus:ring-sol-accent/25"
                />
                <span className="text-sm font-bold text-sol-ink">💻 Lokal AI (Edge / Ollama)</span>
              </label>
            </div>
            ...
            {aiProvider === "anthropic" ? (
              <div>
                ...
                />
                <p className="mt-1 text-xs text-sol-muted">
                  Driver Vibe Designer, AI Konsulent og Tool Calling.
                </p>
              </div>
            ) : (
              <div className="rounded-lg border border-sol-accent/30 bg-sol-accent/5 p-4 space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-[10px] text-sol-muted">
                    Sørg for at tilføje <code>/v1</code> da vi bruger OpenAI komptabilitet (Delegate Agent Mechanism).
                  </p>
                </div>
                <div>
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-sol-muted">
                Bruges altid uafhængigt til Auto-Oversæt, SEO-tekster og Theme-generering. Hent nøgle fra Google AI Studio.
              </p>
            </div>
          </div>
        )}
