              ...
              <div>
                ...
                >
                  {/* P1.4: dynamisk fra INDUSTRY_TEMPLATE_OPTIONS — nye industries
                      ...
                      v0.6.0: premium templates (studio, agent-marketplace) får "⭐ Pro"
                      suffix når brand.features.cartwrightPlus === false (honor-system
                      MVP — alle templates er teknisk valgbare uanset flag). */}
                  {INDUSTRY_TEMPLATE_OPTIONS.map(({ slug, label }) => {
                    const isPremium = slug === "studio" || slug === "agent-marketplace";
                    const isPlus = brand.features.cartwrightPlus;
                    const suffix = isPremium && !isPlus ? " ⭐ Pro" : "";
                    return (
