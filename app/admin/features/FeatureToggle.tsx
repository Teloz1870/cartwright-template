...
/**
 * Per-række live-toggle for en runtime-feature. Optimistisk: flipper lokalt med
 * det samme, kalder server-action'en, og ruller tilbage + viser fejl hvis
...
export function FeatureToggle({
  ...
  /** Hvis sat OG feature er OFF: kan ikke tændes endnu (vis grund, disable). */
  ...
  // Blokeret (dependency/precondition) gælder kun når man vil TÆNDE en slukket.
