...
const inputClass =
  "w-full rounded-lg border border-sol-ink/15 bg-white px-3 py-2 text-sm text-sol-ink focus:border-sol-accent focus:outline-none focus:ring-2 focus:ring-sol-accent/20";
