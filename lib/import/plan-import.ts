 ...
 * for the body/media/markdown the tools require. The Fase 1.2 prerequisites
 * (a posts.create + services.create tool, a draft column, …) are tracked in
 * internal-docs/content-import-ultraplan.md §5a.
 */
