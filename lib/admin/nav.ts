...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/admin/kunder", label: "Kunder", ecommerce: true },
      {
      ...
      { href: "/admin/anmeldelser", label: "Anmeldelser", flags: ["reviews"] },
