...
const DESCRIPTORS: Record<FeatureKey, Omit<FeatureDescriptor, "key" | "runtimeToggleable">> = {
  ...
  componentRegistryShipsSource: {
    ...
    description:
      "Sub-flag til komponent-registry'en: server ud over schema også faktisk MIT-licenseret TSX + token-CSS for et kurateret, fuldt selvstændigt subset af Studio-atomer (ægte installerbar shadcn-kilde). Aldrig proprietær/server-importerende/tredjeparts-kode.",
    group: "Discovery & AI",
    tier: "runtime",
