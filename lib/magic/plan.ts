...
- vælg valgfrit en diskret scroll-effekt i 'effect' fra: ${SECTION_EFFECTS.join(", ")}, eller "none". Brug effekter SPARSOMT og smagfuldt — de fleste sektioner bør være "fade-up" eller "none"; "parallax" passer kun til store medie-/hero-sektioner; undgå at animere alt (det virker billigt). Effekten respekterer automatisk reduced-motion.`,
      }),
  );
