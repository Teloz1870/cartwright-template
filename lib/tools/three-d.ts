...
export const configureThreeDTool = defineTool({
  ...
  description:
    "Configure the Live Canvas 3D hero. scene: floating-geometry | particles | blob | wireframe. intensity: 0..1 (density/speed). paletteSource: theme | custom. Any subset may be set. Applies instantly (30s cache). Requires confirm: true. Revertible via audit.revert.",
