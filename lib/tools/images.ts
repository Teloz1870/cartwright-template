...
export const searchUnsplashTool = defineTool({
  ...
  description:
    "Search product images on Unsplash (free stock photo service). Returns 4 candidates with thumbnails. The AI should call this after products.create to give the admin image choices. Best queries: 'brand model sunglasses' (for example 'ray ban wayfarer sunglasses') or 'category sunglasses' (for example 'aviator sunglasses gold'). If there are 0 hits, try a broader query.",
  scope: "catalog:read",
