...
/**
 * B3 registry seam — the COMMERCE tool packs (site-profile program,
 * `internal-docs/site-profile-ultraplan.md` §5 + the mcp module's
 * knownDeviations ledger in modules/registry.ts).
 *
