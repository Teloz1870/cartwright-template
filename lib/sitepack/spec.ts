 ...
 * engine version (see internal-docs/sitepack-ultraplan.md). This module is the
 * pure contract: version axes + the manifest Zod. No I/O, no DB, no server-only
 * — safe to import anywhere and fully unit-testable.
 *
 * Two independent version axes (ultraplan §3.2 / §6):
