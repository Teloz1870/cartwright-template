...
export const SECTION_REGISTRY = {
  hero: defineSection({
    ...
    defaultProps: {
      ...
      tagline: "A short sentence describing what you offer.",
  ...
  stackGrid: defineSection({
    ...
    defaultProps: {
      ...
      stack: ["Sustainable materials", "Local production", "Handmade", "Quality assured"],
    },
    Component: StudioStackGrid,
  }),
  statBand: defineSection({
    label: "Stat band (numbers)",
  ...
  vibe: defineSection({
    ...
    defaultProps: {
      html:
        '<section class="px-6 py-16 text-center"><h2 class="text-2xl font-semibold">AI-generated section</h2><p class="mt-2 text-stone-500">Use “Generate with v0” in the inspector, or paste your own HTML.</p></section>',
    },
