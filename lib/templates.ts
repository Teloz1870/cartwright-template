...
<div class="min-h-screen bg-[#0A0A0A] text-white font-sans selection:bg-blue-500/30">
  ...
  <section class="relative pt-32 pb-20 px-4 max-w-7xl mx-auto text-center z-10">
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-center">
      <a href="/contact" class="bg-white text-black px-8 py-4 rounded-lg font-bold hover:bg-white/90 transition-colors shadow-[0_0_40px_rgba(255,255,255,0.3)]">Start for free</a>
