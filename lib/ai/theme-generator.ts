...
- **accent** (#rrggbb): primary brand color. Used for CTA buttons, price tags, badges. Must be rich and suitable for ecommerce - NOT neon, NOT pastel. Counterexamples: #1e3f5a (deep navy for premium apparel), #2c4a1e (forest green for outdoor gear), #a85a3c (warm clay for ceramics).
