...
- attributes: key/value pairs of technical specs - choose labels appropriate for the product type. Industry examples: sunglasses (Frame color: Black, UV: UV400), fencing (Height: 180cm, Material: Galvanized), ceramics (Weight: 320g, Dishwasher safe: Yes).`;
