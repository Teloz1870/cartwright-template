...
## v0.21.0 — 2026-06-05 (UNRELEASED — local only, pending operator review)

The Google Workspace modules on top of the v0.20.0 connector, plus subscriptions. All additive and
**flag-OFF**. Built/reviewed/integrated locally in the same overnight run as v0.20.0; **not pushed**.
