...
- **`docs/simple-site.md`** gains "What you edit" (the `brand.config.ts`
  ...
  (~22 s scaffold + install · ~27 s `next build` · ~2 s to HTTP 200 with a
  rendered H1; 20 runtime / 16 dev dependencies; 423 files — copied from the
  release scaffold gate's `timings-site.json`, run 34040202701, never typed)
  and "Honest limits".
