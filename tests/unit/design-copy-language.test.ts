...
const DA_WORDS =
  /\b(og|ikke|hvis|vores|som|der|ved|kun|hver|inden|af|fra|eller|kan|skal|det|hos|dig|levering\w*|betaling\w*|handler|trygt|udvalgt\w*|hurtig|sikker|vælger|kunderne|hverdage|påkrævet|kvalitet|fokus)\b/;
