...
describe("fork-readiness invariants", () => {
  ...
  it("brand.industryTemplate matcher en eksisterende template (UL4)", () => {
    ...
    // Website-mode templates (e.g. website-corporate) ship no catalogue —
    // they're marketing sites. Always require pages; only require a catalogue
    // when the template actually has products.
