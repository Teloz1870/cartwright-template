...
// Pin the base locale (see i18n-dynamic.test.ts): localize() only applies a
// translation when locale !== brand.defaultLocale. The engine is da-default but
// a website scaffold is en-default, which would make getPublishedPost(_, "en")
// return the base (Danish) text instead of the en translation. Override only
// defaultLocale; keep the rest of brand real.
