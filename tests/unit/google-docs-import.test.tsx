...
// fail-soft path without a Google connection. The implementation moved to the
// google-workspace plugin — mock the plugin module (the @/lib/google/client
// shim re-exports it, so the shim import below sees the same mock).
vi.mock("@/plugins/google-workspace/lib/google/client", () => ({
