 ...
 * draft). It is served `force-static` with public CORS + a 24 h cache. The
 * route was untested at the handler level: `llms-txt.test.ts` only asserts that
 ...
 * a different surface. The uncovered seam (named in STATE.md 2026-07-03):
 *
 *   1. force-static contract — the route MUST stay statically generated
 *      (`export const dynamic = "force-static"`); a regression to force-dynamic
 *      silently changes its caching/serving model.
...
describe("GET /.well-known/mcp.json — static/caching contract", () => {
  it("is served force-static (must not regress to force-dynamic)", () => {
