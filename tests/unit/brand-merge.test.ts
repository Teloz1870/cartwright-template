...
describe("getBrand merge-logic", () => {
  ...
  it("webshop-mode: DB kan tænde ecommerceEnabled og override identitet", async () => {
    // Kontrast-case til website-mode-locken nedenfor: i webshop-mode ER
    // DB-overrides af identitet tilladt.
    mocks.prisma.brandingSettings.findUnique.mockResolvedValue({
      id: 1,
