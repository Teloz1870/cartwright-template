...
// The implementation moved to the google-workspace plugin — mock the plugin
// module (the @/lib/google/client shim re-exports it, so imports through the
// shim see the same mock).
