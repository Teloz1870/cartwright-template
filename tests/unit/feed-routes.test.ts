 ...
 * UNCOVERED (named in STATE.md 2026-07-05 after #349) is the ROUTE WIRING: the
 * options each handler threads into its serializer, its 404 gating, its cache
 * headers. A regression there silently corrupts what AI shopping agents read,
