...
describe("feature manifest ↔ brand.config sync", () => {
  ...
  it("webMcp er default-off (canary byte-identisk indtil tændt)", () => {
    // Layout-mountet + per-side-mounts renderer intet når flaget er off —
    // eksperimentet holdes AF canary-mosaikken (AGENTIC-WEB-VERIFICATION-2026).
