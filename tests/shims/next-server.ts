...
export class NextRequest extends Request {
  // Nok overflade til route-handlers der læser query-params via
  // request.nextUrl.searchParams (fx /api/v1/tools). En URL er duck-type-
  // kompatibel med NextURL for netop dét brug.
  get nextUrl(): URL {
