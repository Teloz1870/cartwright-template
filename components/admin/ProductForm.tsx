...
type ProductFormProduct = {
  ...
  /** AEO (answer-first) felter — gated på brand.features.aeoContent. */
...
type ProductFormProps = {
  ...
  /** Resolved brand.features.aeoContent (fra server). Viser AEO-felterne når true. */
  aeoEnabled?: boolean;
};
...
export default function ProductForm({ categories, product, aeoEnabled = false }: ProductFormProps) {
  ...
  // AEO (answer-first) felter. faq gemmes som JSON-streng i DB (som Category.faq);
    ...
    startGenerating(() => {
      void (async () => {
        ...
        if (result.ok) {
          ...
          // AEO-felter fyldes når generatoren returnerer dem (gated på aeoContent).
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        {/* AEO (answer-first) content — gated på brand.features.aeoContent.
            Når flaget er off bevares evt. eksisterende værdier via hidden inputs
            (så et gem ikke utilsigtet rydder dem) — kun UI'et skjules. */}
        {aeoEnabled ? (
          <div className="md:col-span-2 rounded-lg border border-sol-glass-border-dark bg-sol-cream/50 p-4">
            <div className="mb-3">
              <h3 className="text-sm font-black text-sol-ink">
              ...
              <p className="mt-0.5 text-xs text-sol-muted">
                Hjælper AI-svarmotorer citere produktet. Vises på produktsiden +
                emitteres som FAQPage JSON-LD når udfyldt.
              </p>
            </div>
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  placeholder="Ét direkte svar: hvad produktet er, og hvem det er til."
                  className={inputClass}
                />
                <p className="mt-1 text-xs text-sol-muted">
                  {answerSummary.length}/500 · vises som fremhævet lead øverst på produktsiden
                </p>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={`[{"q": "Spørgsmål?", "a": "Svar."}]`}
                  className={`${inputClass} font-mono text-xs`}
                />
                <p className="mt-1 text-xs text-sol-muted">
                  3-5 stk. Hvert spørgsmål skal kunne stå alene (isolérbar kontekst) → FAQPage JSON-LD.
                </p>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={`[{"title": "Til daglig brug", "description": "…"}]`}
                  className={`${inputClass} font-mono text-xs`}
                />
              </div>
