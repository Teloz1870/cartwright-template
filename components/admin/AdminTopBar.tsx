  ...
  return (
    ...
    >
      ...
      <div className="ml-auto flex items-center gap-1">
        ...
        {/* NB: ThemeToggle er bevidst fjernet fra admin — den globale `.dark`
            klasse temaer KUNDENS storefront, og admin må aldrig style kundens
            site. Komponenten lever videre i components/ThemeToggle.tsx til
            design-packs der senere opter ind i storefront-dark (Phase 3). */}
