...
/**
 * AdminPageHeader — Polaris page title. Replaces the ubiquitous
 * `<div flex justify-between><h1 text-3xl font-black>…` pattern. The title is now
 * `text-2xl font-semibold` (Polaris weight rather than font-black 900).
 */
