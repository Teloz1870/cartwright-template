...
export default function AdminChatLauncher() {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-sol-ink/40 dark:bg-black/60 backdrop-blur-sm p-4"
      role="dialog"
    ...
    >
      ...
      />
      <div className="relative z-10 overflow-hidden rounded-2xl bg-sol-cream dark:bg-sol-ink shadow-2xl">
        <AdminChatPanel compact />
        <div className="border-t border-sol-ink/10 bg-sol-cream dark:bg-sol-ink px-4 py-2 text-[10px] text-sol-muted">
