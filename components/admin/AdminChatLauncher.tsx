...
/**
 * Global ⌘K launcher in the admin layout. Listens for a keyboard event and opens
 * an overlay panel with AdminChatPanel in compact mode. Used when an admin is
 * inside e.g. /admin/ordrer/123 and wants to ask a quick question without
 * changing page.
 */
export default function AdminChatLauncher() {
  ...
  useEffect(() => {
    ...
    // AdminTopBar's search field opens the palette via this window event (avoids
    // lifting the open state out of this component).
