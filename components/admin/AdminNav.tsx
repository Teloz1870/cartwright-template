...
function NavGroupDisclosure({ group }: { group: NavGroup }) {
  ...
  return (
    ...
    >
      <summary className="flex cursor-pointer list-none items-center gap-2 rounded-lg px-3 py-2 text-xs font-black uppercase tracking-wide text-white/55 transition hover:bg-white/10 hover:text-white/90 [&::-webkit-details-marker]:hidden">
