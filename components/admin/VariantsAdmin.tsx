 ...
 * dækker panel-hegn-use-case (3-15 variants pr. produkt typisk).
 */
  ...
  return (
    <div className="md:col-span-2 rounded-lg border border-sol-glass-border-dark bg-sol-cream/30 p-4">
      ...
      {/* ULTRAPLAN-lite UL3: bulk-matrix-generator.
          For produkter med mange variants (panel-hegn: 4 heights × 5 widths × 3 colors
...
/**
 * Beregn cartesian product af more attribute-arrays.
