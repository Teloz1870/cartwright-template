...
export default function CategoryForm({ category }: CategoryFormProps) {
  ...
  return (
    ...
    >
      ...
      {videoNotice && (
        <div className="mb-5 flex items-center gap-3 rounded-lg border border-purple-500/30 bg-purple-500/5 px-4 py-3 text-sm font-bold text-purple-700">
          {isVideoGenerating && (
        ...
        <div className="md:col-span-2">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <button
              ...
              className="rounded-lg bg-purple-600 px-3 py-1.5 text-xs font-black text-white transition hover:bg-purple-700 disabled:cursor-not-allowed disabled:opacity-50"
            >
