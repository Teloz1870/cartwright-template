...
const SORT_OPTIONS = [
  { value: "nyeste", label: "Newest" },
  { value: "pris-op", label: "Price: low to high" },
  { value: "pris-ned", label: "Price: high to low" },
];
    ...
    <aside className="flex flex-col gap-4 w-full">
      ...
      <div>
        ...
        <select
          ...
          className={SELECT_CLASS}
        >
          <option value="">All frame colors</option>
          {frameColors.map((fc) => (
      ...
      <div>
        ...
        <select
          ...
          className={SELECT_CLASS}
        >
          <option value="">All lens colors</option>
          {lensColors.map((lc) => (
