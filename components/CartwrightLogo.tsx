/**
 * Cartwright wordmark — lowercase "cartwright" with a brand-purple dot on the
 ...
 * a violet). Set the wordmark colour with a text-colour class on the parent.
 */
export function CartwrightLogo({
  className = "",
  title = "Cartwright",
  dotColor = "var(--cw-brand, #7c5cff)",
  dotGlow = "rgba(124,92,255,0.7)",
  textGradient,
}: {
  className?: string;
  title?: string;
  /** Override the dot fill (e.g. black when the wordmark sits on a purple banner). */
  dotColor?: string;
