      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            {/* Two independent conditions: `accountAndAdmin` is whether the
                route EXISTS in this scaffold (a --profile site build prunes
                app/[locale]/account with the auth module), `ecommerceEnabled`
                is whether this shop wants to show it. A site scaffold whose
                owner flips ecommerceEnabled would otherwise link a 404. */}
            {profileCapabilities.accountAndAdmin && ecommerceEnabled && (
              <Link
