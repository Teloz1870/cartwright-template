...
export function ConsentProvider({
  ...
  useEffect(() => {
    ...
    if (cookie) {
      ...
      /* eslint-disable-next-line react-hooks/set-state-in-effect -- intentional on-mount cookie re-read for the cross-page "just decided" race; flagged for review (consent gating). */
      setConsent(parsed);
