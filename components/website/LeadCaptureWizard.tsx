...
const OptionCard = ({ title, desc, icon, selected, onClick }: { title: string; desc: string; icon: ReactNode; selected: boolean; onClick: () => void }) => (
  <div 
    onClick={onClick}
    ...
    <div className="w-full max-w-4xl mx-auto py-12">
      ...
      <AnimatePresence mode="wait">
        {step === 1 && (
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-black text-white mb-4 tracking-tight">{t("wizardStep1Title")}</h2>
            <p className="text-white/60 text-lg mb-10 font-light">{t("wizardStep1Help")}</p>
        ...
        {step === 2 && (
          ...
          >
            ...
            <p className="text-white/60 text-lg mb-10 font-light">{t("wizardStep2Help")}</p>
        ...
        {step === 3 && (
          ...
          >
            ...
            <p className="text-white/60 text-lg mb-10 font-light">{t("wizardStep3Help")}</p>
            ...
            <form onSubmit={handleSubmit} className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md">
              ...
              <button disabled={isSubmitting} type="submit" className="w-full bg-[#d4af37] text-[#050A19] font-black text-lg py-4 rounded-xl hover:bg-[#b0902c] transition-colors disabled:opacity-50">
                {isSubmitting ? t("wizardSubmitting") : t("wizardSubmit")}
              </button>
            </form>
          </motion.div>
        )}
        ...
        {step === 4 && (
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl font-black text-white mb-6 tracking-tight">{t("wizardThanksHeading")}</h2>
