...
export default async function Header() {
  ...
  // First-run brand placeholder: until the owner makes the site theirs
  // (completes the setup wizard or picks a design), the header leads with the
  // Cartwright wordmark instead of the default store name + mark. Cheap proxy
  // (no extra query). Engine firstRunWelcome=false ⇒ false on every configured
  // canary, so live sites keep their own logo.
  const firstRunBrand =
