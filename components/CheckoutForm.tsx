...
export default function CheckoutForm() {
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-5">
      ...
      {[
        { name: "shippingName", label: "Full name", type: "text", autoComplete: "name", placeholder: "Your full name" },
        { name: "email", label: "Email", type: "email", autoComplete: "email", placeholder: "you@example.com" },
        { name: "shippingAddress", label: "Delivery address", type: "text", autoComplete: "street-address", placeholder: "Street and number" },
      ].map((f) => (
        <div key={f.name}>
      ...
      <div className="grid grid-cols-[120px_1fr] gap-4">
        <div>
          <label htmlFor="shippingZip" className={labelClass}>Postcode</label>
          <input
            id="shippingZip"
            name="shippingZip"
            type="text"
        ...
        <div>
          <label htmlFor="shippingCity" className={labelClass}>City</label>
          <input
            id="shippingCity"
            name="shippingCity"
            type="text"
      ...
      <div>
        <label htmlFor="discountCode" className={labelClass}>
          Discount code <span className="text-sol-muted font-normal">(optional)</span>
        </label>
        <input
          id="discountCode"
          name="discountCode"
