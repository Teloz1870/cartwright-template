 ...
 *
 * Full showcase: a soft lilac→blue glass gradient hero with frosted-glass
...
export default async function WelcomeCanvas() {
  ...
  return (
    ...
    >
      {/* ── Hero banner: vivid Cartwright-purple gradient (the same nuance as
      ...
      <section className="relative isolate overflow-hidden bg-[linear-gradient(157deg,var(--cw-brand),var(--cw-brand-glow-1))]">
        ...
        <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center px-6 pt-12 pb-16 text-center sm:pt-14 sm:pb-20">
          ...
          <h1 className="mt-4 max-w-2xl text-balance bg-gradient-to-br from-white via-[#e6dcff] to-[#b6d0ff] bg-clip-text text-4xl font-semibold leading-[1.05] tracking-tight text-transparent sm:text-5xl">
            {t("headline")}
          </h1>
      ...
      <section className="relative z-10 mx-auto -mt-8 max-w-6xl px-6 pb-12">
        ...
        <ol className="grid gap-4 lg:grid-cols-3">
          {/* 01 — Build it with AI */}
          <li className="cw-card-rise group/card flex flex-col rounded-3xl border border-cw-stone-200 bg-cw-stone-50/95 p-5 shadow-[0_30px_70px_-36px_rgba(23,20,17,0.4)] backdrop-blur transition duration-300 hover:-translate-y-1 hover:border-[var(--cw-brand)]/40 hover:shadow-[0_44px_80px_-32px_rgba(124,92,255,0.45)]">
          ...
          <li className="cw-card-rise group/card flex flex-col rounded-3xl border border-cw-stone-200 bg-cw-stone-50/95 p-5 shadow-[0_30px_70px_-36px_rgba(23,20,17,0.4)] backdrop-blur transition duration-300 hover:-translate-y-1 hover:border-[var(--cw-brand)]/40 hover:shadow-[0_44px_80px_-32px_rgba(124,92,255,0.45)]">
            ...
            <p className="mt-auto pt-4">
              ...
              <a
                href="/admin/setup"
                className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[var(--cw-brand)] to-[var(--cw-brand-glow-1)] px-5 py-2.5 text-sm font-semibold text-white shadow-[0_12px_30px_-10px_rgba(124,92,255,0.7)] transition hover:from-[var(--cw-brand-glow-2)] hover:to-[var(--cw-brand-glow-3)]"
              >
                {t("setupCta")} →
              </a>
            </p>
      ...
      {/* ── Dedicated first-run footer — purple-matched, replaces the site
      ...
      {/* While the welcome canvas is live, keep the first run distraction-free.
          ...
          lockup (hero) and its own purple footer, so the shared chrome is pure
          noise here. Hide all three:
            ...
            • [data-site-footer]     — clashes with the dedicated purple footer.
          ...
          dedicated purple one and the AI FAB would show. Acceptable — this is
          ...
          <div className="flex flex-col items-center gap-8 text-center sm:flex-row sm:items-end sm:justify-between sm:text-left">
            ...
            <div className="flex flex-col items-center gap-3 sm:items-end">
              <Link
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-[var(--cw-brand)] to-[var(--cw-brand-glow-1)] px-5 py-2.5 text-sm font-semibold text-white shadow-[0_12px_30px_-10px_rgba(124,92,255,0.7)] transition hover:-translate-y-px hover:from-[var(--cw-brand-glow-2)] hover:to-[var(--cw-brand-glow-3)]"
              >
                {t("engine")} →
              </Link>
