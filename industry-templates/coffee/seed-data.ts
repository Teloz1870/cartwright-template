...
export const coffeeTemplate: IndustryTemplate = {
  ...
  categories: [
    ...
    },
    {
      name: "Gear",
      slug: "gear",
      description: "Brewers, grinders and filters — the kit our roastery uses.",
    },
  ],
...
Dette er en Cartwright-demo. Du indtaster ikke rigtige betalingsdata her; ordrer slettes natligt sammen med øvrig demo-data.`,
  ...
  products: [
    ...
    },
    {
      ...
      categorySlug: "beans",
      featured: true,
      // The template's one variant-ful product, mirroring the live Northbound
      // demo: it keeps the PDP's variant picker and the WebMCP
      // `add_current_product_to_cart` tool's `variant` enum exercised from
      // first seed. One attribute key ⇒ one dropdown; the value is the whole
      // natural-language option ("Whole beans, 250 g") because agent surfaces
      // derive the variant label by joining attribute VALUES. Every other
      // product stays variant-less on purpose — an agent must handle both.
      variants: [
        {
          sku: "colombia-supremo-whole-250",
          priceDkk: 12900,
          stock: 18,
          attributes: { "Grind & size": "Whole beans, 250 g" },
        },
        {
          sku: "colombia-supremo-filter-250",
          priceDkk: 12900,
          stock: 12,
          attributes: { "Grind & size": "Ground for filter, 250 g" },
        },
        {
          sku: "colombia-supremo-whole-1kg",
          priceDkk: 39900,
          stock: 6,
    ...
    },
    {
      ...
      slug: "kenya-nyeri-aa",
      description:
        "Vivid blackcurrant acidity and a long, sweet finish. AA-grade lots from smallholder washing stations in Nyeri.",
      priceDkk: 15900,
      images: [
    ...
    },
    {
      ...
      description:
        "Earthy, full-bodied Sumatran with dark chocolate, cedar and a syrupy finish. Wet-hulled the traditional way.",
      priceDkk: 13900,
      images: [
      ...
      attributes: {
        ...
        process: "Wet-hulled",
        roast: 4,
        notes: ["dark chocolate", "cedar", "syrup"],
        weightG: 250,
      },
      categorySlug: "beans",
    },
    ...
    // ── Gear ────────────────────────────────────────────────────────────────
    // Non-coffee products on purpose: they carry plain string attributes (no
    // roast/strength), so every attribute-reading surface — PDP spec rows, the
    // brew calculator's strength search, PLP filters — is exercised against
    // products where the coffee vocabulary is absent.
    {
      name: "Gooseneck Pour-Over Kettle",
      slug: "gooseneck-kettle",
      description:
        "1.0 L stainless gooseneck kettle with thermometer lid. Precise, slow pours for even extraction.",
      priceDkk: 34900,
      images: [
        "https://images.unsplash.com/photo-1522992319-0365e5f11656?w=800",
      ],
      stock: 15,
      attributes: {
        capacity: "1.0 L",
    ...
    {
      name: "Steel Burr Hand Grinder",
      slug: "hand-grinder-steel",
      description:
        "48 mm steel burrs, stepless adjustment, magnetic catch cup. Grinds a V60 dose in under 30 seconds.",
      priceDkk: 44900,
      images: [
        "https://images.unsplash.com/photo-1570784332176-fdd73da66f03?w=800",
      ],
      stock: 10,
      attributes: {
        burrs: "48 mm steel",
    ...
    },
    {
      ...
      slug: "hario-v60-02",
      description:
        "The pour-over classic. Ceramic 02 dripper for 1–4 cups — the brewer our roastery uses for every cupping.",
      priceDkk: 9900,
      images: [
    ...
    {
      name: "Paper Filters (02, 100 pcs)",
      slug: "paper-filters-02",
      description:
        "Oxygen-bleached cone filters for the 02 dripper. Rinse once, brew clean.",
      priceDkk: 4900,
      images: [
