 ...
 * fields — they should use Product.attributes JSON instead. The columns only
 * still exist because the original eyewear shop's data and filter facets read
 * them; giving them a second, unrelated meaning per vertical is how a schema
